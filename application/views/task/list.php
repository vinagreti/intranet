<div class="span10">
	...
	<h5>
		<a class="taskListFilter btn btn-primary" href="#" rel="tooltip" title="Filtro"><i class="icon-search icon-white"></i> </a>
		<a class="taskFilterButton btn btn-info" href="#" rel="tooltip" title="Atualizar lista"><i class="icon-refresh icon-white"></i></a>
